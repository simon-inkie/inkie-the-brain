/**
 * the-brain — OpenClaw context engine plugin adapter.
 *
...
import { TheBrainEngine, parseConfig } from "../../../../core/context-engine/index.js";

export { TheBrainEngine, sliceRecent, approxChars, readInjectedMemoryBlock, parseConfig, DEFAULT_CONFIG } from "../../../../core/context-engine/index.js";
export type { TheBrainConfig } from "../../../../core/context-engine/index.js";
...
export default definePluginEntry({
  ...
  register(api) {
    ...
    api.registerContextEngine("the-brain", (() => {
      const cfg = parseConfig(pluginConfig, process.env.HOME);
      return new TheBrainEngine(cfg);
    }) as any);
  },
});
